...
uses
  ...
  AuxTypes, MemoryBuffer, CountedDynArrayInt32, IniFileEx,
...
begin
Ini.WriteInt32(Section,Key,GetItem(Index));
end;
...
begin
SetItem(Index,Int32(Ini.ReadInteger(Section,Key,GetItem(Index))));
end;
...
begin
SetItem(Index,Ini.ReadInt32(Section,Key,GetItem(Index)));
end;
...
begin
SetItem(Index,Int32(Reg.ReadInteger(Value)));
end;

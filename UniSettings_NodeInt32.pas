...
begin
Ini.WriteInt32(Section,Key,fValue);
end;
...
begin
SetValue(Int32(Ini.ReadInteger(Section,Key,fValue)));
end;
...
begin
SetValue(Ini.ReadInt32(Section,Key,fValue));
end;
...
begin
SetValue(Int32(Reg.ReadInteger(Value)));
end;
...
var
  ...
  TempIndex:      Integer;
begin
If AccessLeafNodeTypeIsArray(ValueName,vtInt32,'Int32ValueGetNoLock',TempNode,TempValueKind,TempIndex) then
...
var
  ...
  TempIndex:      Integer;
begin
If AccessLeafNodeTypeIsArray(ValueName,vtBool,'Int32ValueSetNoLock',TempNode,TempValueKind,TempIndex) then
  case TempValueKind of

...
uses
  ...
  AuxTypes, MemoryBuffer, CountedDynArrayUInt32, IniFileEx,
...
begin
Ini.WriteUInt32(Section,Key,GetItem(Index));
end;
...
begin
SetItem(Index,UInt32(Ini.ReadInteger(Section,Key,GetItem(Index))));
end;
...
begin
SetItem(Index,Ini.ReadUInt32(Section,Key,GetItem(Index)));
end;
...
begin
SetItem(Index,UInt32(Reg.ReadInteger(Value)));
end;

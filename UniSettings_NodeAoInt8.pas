...
uses
  ...
  AuxTypes, MemoryBuffer, CountedDynArrayInt8, IniFileEx,
...
begin
Ini.WriteInt8(Section,Key,GetItem(Index));
end;
...
begin
SetItem(Index,Int8(Ini.ReadInteger(Section,Key,GetItem(Index))));
end;
...
begin
SetItem(Index,Ini.ReadInt8(Section,Key,GetItem(Index)));
end;
...
begin
SetItem(Index,Int8(Reg.ReadInteger(Value)));
end;

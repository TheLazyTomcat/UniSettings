...
begin
Ini.WriteUInt16(Section,Key,fValue);
end;
...
begin
SetValue(UInt16(Ini.ReadInteger(Section,Key,fValue)));
end;
...
begin
SetValue(Ini.ReadUInt16(Section,Key,fValue));
end;
...
begin
SetValue(UInt16(Reg.ReadInteger(Value)));
end;

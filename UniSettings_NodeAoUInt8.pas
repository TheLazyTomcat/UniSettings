...
uses
  ...
  AuxTypes, MemoryBuffer, CountedDynArrayUInt8, InifileEx,
...
begin
Ini.WriteUInt8(Section,Key,GetItem(Index));
end;
...
begin
SetItem(Index,UInt8(Ini.ReadInteger(Section,Key,GetItem(Index))));
end;
...
begin
SetItem(Index,Ini.ReadUInt8(Section,Key,GetItem(Index)));
end;
...
begin
SetItem(Index,UInt8(Reg.ReadInteger(Value)));
end;

...
ReadLock;
try
  with TUNSNodeInt16(CheckedLeafNodeTypeAccess(ValueName,vtBool,'Int16ValueGet')) do
    If AccessDefVal then
      Result := Value
    else
      Result := DefaultValue;
...
WriteLock;
try
  with TUNSNodeInt16(CheckedLeafNodeTypeAccess(ValueName,vtBool,'Int16ValueSet')) do
    If AccessDefVal then
      Value := NewValue
    else

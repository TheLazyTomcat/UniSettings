...
ReadLock;
try
  with TUNSNodeInt64(CheckedLeafNodeTypeAccess(ValueName,vtBool,'Int64ValueGet')) do
    If AccessDefVal then
      Result := Value
    else
      Result := DefaultValue;
...
WriteLock;
try
  with TUNSNodeInt64(CheckedLeafNodeTypeAccess(ValueName,vtBool,'Int64ValueSet')) do
    If AccessDefVal then
      Value := NewValue
    else
